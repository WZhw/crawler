#ifndef BLOOM2_H_INCLUDED
#define BLOOM2_H_INCLUDED
#include<stdlib.h>
#include<assert.h>
#include<stdio.h>
#include<unistd.h>
...
int bloomDomain(char *domain, char *origin_domain){
    return (strcmp(domain, origin_domain) == 0);
}
